export default function Navbar() {
    return (
      <nav className="w-full bg-antiqueWhite/90 backdrop-blur shadow p-4 fixed top-0 z-50 border-b border-taupe/30">
        <div className="flex justify-center space-x-6 text-gray-800 font-medium">
          ...
          <a href="#academic-coursework" className="hover:text-roseHover">Coursework</a>
